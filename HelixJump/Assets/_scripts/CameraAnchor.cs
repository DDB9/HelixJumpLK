...
public class CameraAnchor : MonoBehaviour
{
    ...
    IEnumerator UpdateAnchorAsync()
    {
        ...
        {
            Debug.LogWarning(string.Format("CameraAnchor found ViewportHandler instance after waiting {0} frame(s). You might want to check that ViewportHandler has an early execution order.", cameraWaitCycles));
        }
        UpdateAnchor();
